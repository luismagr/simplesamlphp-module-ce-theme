...
?>
	...
	<meta name="theme-color" content="#4572FD"/>
...
<div id="wrap">
    ...
    <div id="header">
        ...
        <h1><a href="/<?php echo $this->data['baseurlpath']; ?>"><?php
            echo(isset($this->data['header']) ? $this->data['header'] : 'Code Enigma');
        ?></a></h1>
    </div>
